...
$options['alias-path'] = array($configpath . '/drush-aliases');

/**
 * Specify the folder for to search for Drush recipes
 */
$options['dr_locations'] = array($configpath . '/drecipes');
...
$options['gzip'] = TRUE;
$options['result-file'] = realpath(getcwd() . '/..') . '/db/@DATABASE.sql';
